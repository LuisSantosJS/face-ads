...
export default async function handler(
    ...
    const query = `
    curl -i -X GET \
    "https://graph.facebook.com/v17.0/act_${userData.accountId}/adcreatives?fields=asset_feed_spec%2Cimage_url%2Clink_url%2Cname%2Cbody%2Cthumbnail_url%2Ctitle%2Cobject_url&access_token=${userData.token}"
    `
